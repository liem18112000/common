...
import static com.application.common.utils.log.LoggingUtility.extractMethod;
import static com.application.common.utils.log.LoggingUtility.getPackageName;
import static com.application.common.utils.log.LoggingUtility.process;
...
public class ControllerLoggingHandler {
   ...
   */
  private final String LOG_PATTERN = "execution(* com.liem..*Controller.*(..))";
  ...
  public Object logControllerProcess(ProceedingJoinPoint joinPoint) throws Throwable {
    return process(joinPoint, new StopWatch(), getPackageName(
        joinPoint, extractMethod(joinPoint)), "API");
  }
